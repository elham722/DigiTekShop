    ...
    where T : AggregateRoot<TId>
{
    ...
    public EfCommandRepository(DigiTekShopDbContext ctx)
    {
        _ctx = ctx;
        _set = ctx.Set<T>();
    }
    ...
    public async Task<int> DeleteRangeAsync(Expression<Func<T, bool>> predicate, CancellationToken ct = default)
    {
